    ...
    public class Mail
    {
        public static void Initialize()
        {
            ...
            MailDao.SaveLetter(new Letter(
                ...
                @"Dear @, ^^Five birds identified! You're on a roll. Did you know that some birds like to eat corn? ^^Good luck and happy birding, ^The Pelican Town Ornithologist's Guild",
            ...
            MailDao.SaveLetter(new Letter(
                ...
                @"Dear @, ^^Fifteen birds identified!? You're becoming an expert. How about an apple? ^^Good luck and happy birding, ^The Pelican Town Ornithologist's Guild",
            ...
            MailDao.SaveLetter(new Letter(
                ...
                @"Dear @, ^^You've identified every bird Pelican Town has to offer! Your grandmother left you this as a reward for a job well done. He would be very proud of the birder you've become. ^^Until next time, ^The Pelican Town Ornithologist's Guild <",
